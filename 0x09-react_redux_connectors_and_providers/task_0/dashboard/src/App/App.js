...
export const mapStateToProps = (state) => {
  return {
    isLoggedIn: state.get('isUserLoggedIn') || false // Connect uiReducer state to isLoggedIn prop
  };
};
      ...
      >
        <React.Fragment>
          ...
          <div className={css(bodyStyles.App)}>
            <Header />
            {this.props.isLoggedIn ? ( // Use the isLoggedIn prop from mapStateToProps
...
// Connect the component to the Redux store using connect function
